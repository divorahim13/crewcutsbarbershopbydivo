...
// ─── Shield / Sterile ────────────────────────────────
export function SterileIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 2L4 6v6c0 5.25 3.5 10.14 8 11 4.5-.86 8-5.75 8-11V6L12 2z" />
...
// ─── Barber Chair ────────────────────────────────────
export function ChairIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// ─── Comb / Services ─────────────────────────────────
export function CombIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
